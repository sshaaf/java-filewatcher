 ...
 * @version 1.0.0
 * 
 * The abstract class is an interface to hold the list of files in a watcher directory.
 * 
 * 
 */
public abstract class AbstractFileListAdapter {
	...
	/**
	 * Compare the File in parameter to the one in the Map. and makes a decision if its created or modified.
	 * Delete is unimplemented at this time.
	 * @param inProcessFile
	 * @return
	 */
	...
	/**
	 * Put a file in the map with the lastModified time. 
	 * This will offcourse be overwritten the first time an update operation is checked. if(lastModified < inComing.lastModified())
	 * @param file
	 * @param lastModified
	 */

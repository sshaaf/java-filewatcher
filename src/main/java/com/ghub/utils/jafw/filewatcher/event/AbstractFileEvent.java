...
public abstract class AbstractFileEvent implements FileEvent{
	...
	/* (non-Javadoc)
	 * @see com.ghub.utils.jafw.filewatcher.event.FileEvent#setFile(java.io.File)
	 */
	...
	/* (non-Javadoc)
	 * @see com.ghub.utils.jafw.filewatcher.event.FileEvent#setWatcherFile(java.io.File)
	 */

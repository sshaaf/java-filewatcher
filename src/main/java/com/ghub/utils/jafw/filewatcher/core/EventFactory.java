...
public class EventFactory {
     ...
     */
    private static FileEvent create(FileEventType fileEventType)
	    throws EventNotThrowable {
     ...
     * @throws EventNotThrowable
     */
    public static FileEvent createEvent(File file, FileEventType fileEventType)
	    throws EventNotThrowable {
     ...
     * @throws EventNotThrowable
     */
    public static FileEvent createEvent(File watcherFile, File file,
     ...
     * @throws EventNotThrowable
     */
    public static FileEvent createEvent(FileEventType fileEventType)
	    throws EventNotThrowable {

 ...
 * @version 1.0.0
 * 
 * The class is the default implementation for a filewatcher on a single File object. 
 * 
 */
public class FileWatcher extends AbstractFileWatcher{
	...
	/**
	 * accepts a File path, you can add your own FileListAdapter here e.g. database? and a FileFilter for files that
	 * should be filtered when processing the watch.
	 * 
	 * @param file
	...
	/**
	 * accepts a URI file path, you can add your own FileListAdapter here e.g. database? and a FileFilter for files that
	 * should be filtered when processing the watch.
	 * 
	 * @param filePath
	 * @param fileListAdapter
	...
	/**
	 * accepts a URI file path, you can add your own FileListAdapter here e.g. database?
	 * @param filePath
	 * @param fileListAdapter
	 */
	...
	/* (non-Javadoc)
	 * @see com.ghub.utils.jafw.filewatcher.core.AbstractFileWatcher#addListener(com.ghub.utils.jafw.filewatcher.event.FileWatcherListener)
	 */

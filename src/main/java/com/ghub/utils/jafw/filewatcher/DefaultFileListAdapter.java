 ...
 * @version 1.0.0
 * 
 *          A default file list adapter that keeps the file list in memory only.
 *          Thus a restart of the service means a complete re initialisation.
 * 
 */
...
public class DefaultFileListAdapter extends AbstractFileListAdapter {
     ...
     * 
     * @see
     * com.ghub.utils.jafw.filewatcher.core.AbstractFileListAdapter#add(java
     * .io.File)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.ghub.utils.jafw.filewatcher.core.AbstractFileListAdapter#
     * compareToMasterFile(java.io.File)
     */
    @Override
     ...
     * 
     * @see
     * com.ghub.utils.jafw.filewatcher.core.AbstractFileListAdapter#getLastModified
     * (java.io.File)
     */
    @Override
     ...
     * 
     * @see
     * com.ghub.utils.jafw.filewatcher.core.AbstractFileListAdapter#setMap(java
     * .util.HashMap)
     */
    @Override

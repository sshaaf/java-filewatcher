...
public class FileRemovedEvent extends AbstractFileEvent{
	...
	/* (non-Javadoc)
	 * @see com.ghub.utils.jafw.filewatcher.event.AbstractFileEvent#getFileType()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.ghub.utils.jafw.filewatcher.event.AbstractFileEvent#setFile(java.io.File)
	 */
	@Override
